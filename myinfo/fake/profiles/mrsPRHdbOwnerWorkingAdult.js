...
exports.mrsPRHdbOwnerWorkingAdult = {
    ...
    generate: (profileName) => {
        ...
        profile.nationality = {
            ...
            source: "1",
            classification: "C",
            code: domain_1.MyInfoNationalityCode.MALAYSIAN,
            unavailable: false,
        };
        profile.birthcountry = {
            ...
            source: "1",
            classification: "C",
            code: domain_1.MyInfoCountryCode.MALAYSIA,
            desc: domain_1.MyInfoCountryCode.fn.toEnumDesc(domain_1.MyInfoCountryCode.MALAYSIA),
            unavailable: false,
        };
        profile.sex = {
            lastupdated: "2020-01-01",
