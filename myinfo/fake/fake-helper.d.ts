import { MyInfoComponents, MyInfoCountryCode, MyInfoDrivingLicenceValidityCode, MyInfoHDBTypeCode, MyInfoHousingTypeCode, MyInfoLifeStatusCode, MyInfoMaritialStatusCode, MyInfoMerdekaGenerationMessageCode, MyInfoOccupationCode, MyInfoResidentialCode, MyInfoSexCode, MyInfoVehicleStatus } from "../domain";
...
declare type MockParamsPerson = MockParams & MockFinanceParams;
declare type PersonCommon = MyInfoComponents.Schemas.PersonCommon;
declare type Person = MyInfoComponents.Schemas.Person;
...
export declare function transformCpfContributions(cpfContributionHistory: CpfContributionHistory[]): MyInfoComponents.Schemas.Cpfcontributions;
export {};
