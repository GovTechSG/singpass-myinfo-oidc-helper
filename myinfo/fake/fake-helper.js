...
exports.transformItemsWithAdditionalMock = exports.transformCpfContributions = exports.transformChildBirthRecord = exports.FakeMyInfoHelper = exports.OverrideMode = void 0;
...
(function (OverrideMode) {
    OverrideMode["partial"] = "partial";
    OverrideMode["full"] = "full";
    OverrideMode["appendToExisting"] = "append";
})(OverrideMode = exports.OverrideMode || (exports.OverrideMode = {}));
class FakeMyInfoHelper {
    ...
    constructor(attributes) {
        ...
        this.getPerson = (mockParams) => {
            const myinfoPerson = this.getPersonCommon(mockParams);
            if (!lodash_1.isEmpty(mockParams.cpfcontributions)) {
            ...
            if (!lodash_1.isEmpty(mockParams.cpfbalances)) {
                myinfoPerson.cpfbalances = transformItemsWithAdditionalMock(mockParams.cpfbalances);
            }
            if (!lodash_1.isEmpty(mockParams.noabasic)) {
...
function transformCpfContributions(cpfContributionHistory) {
    return {
        source: "1",
        classification: "C",
        lastupdated: null,
...
exports.transformCpfContributions = transformCpfContributions;
...
function transformItemsWithAdditionalMock(item, defaultMockParams = true) {
    ...
    return Object.assign(Object.assign({}, transformedItems), defaultItems);
}
