...
function filterThroughMyInfoAttributes(person, attributes) {
    ...
    if (vehiclesRawCbrAttributes.length > 0) {
        ...
        const filteredVehicleChildrenbirthrecords = lodash_1.map(person.vehicles, (cbr) => filterThroughAttributes(cbr, vehicleBirthrecordsAttributes));
        lodash_1.set(vehicleFilteredPerson, "vehicles", filteredVehicleChildrenbirthrecords);
    }
    return Object.assign(Object.assign(Object.assign({}, childrenFilteredPerson), sponsoredFilteredPerson), vehicleFilteredPerson);
}
/**
