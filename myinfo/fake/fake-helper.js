...
function filterThroughMyInfoAttributes(person, attributes) {
    ...
    if (vehiclesRawCbrAttributes.length > 0) {
        ...
        const filteredVehicleChildrenbirthrecords = Object.assign(Object.assign({}, filterThroughAttributes(person.vehicles, vehicleBirthrecordsAttributes)), generateDefaultMockResponse());
