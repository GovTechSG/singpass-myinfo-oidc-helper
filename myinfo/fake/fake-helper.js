        ...
        this.getPersonBasic = (mockParams) => {
            ...
            if (!lodash_1.isEmpty(mockParams.hdbtype)) {
                myinfoPerson.hdbtype = {
                    ...
                    source: "1",
                    classification: "C",
                    code: domain_1.domainMap.hdbtype.map.descToCode[mockParams.hdbtype],
                    desc: mockParams.hdbtype,
                };
            }
            if (!lodash_1.isEmpty(mockParams.housingtype)) {
                myinfoPerson.housingtype = {
                    lastupdated: "2018-06-01",
                    source: "1",
                    classification: "C",
                    code: domain_1.domainMap.housingtype.map.descToCode[mockParams.housingtype],
            ...
            if (!lodash_1.isEmpty(mockParams.drivingqdlvalidity)) {
                myinfoPerson.drivinglicence = {
                    ...
                    qdl: {
                        validity: {
                            code: domain_1.domainMap.validity.map.descToCode[mockParams.drivingqdlvalidity],
                        },
                    },
                };
            }
            if (!lodash_1.isEmpty(mockParams.vehiclestatus)) {
                myinfoPerson.vehicles = {
                    ...
                    classification: "C",
                    status: {
                        code: domain_1.domainMap.status.map.descToCode[mockParams.vehiclestatus],
                    },
                };
            }
            if (!this.attributes) {
