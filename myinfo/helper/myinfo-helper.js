...
class MyInfoHelper {
    constructor(props) {
        this.constructAuthorizationUrl = (state, purpose) => {
            const queryParams = {
                state,
                purpose,
         ...
         */
        this.getPersonCommon = (uinfin) => __awaiter(this, void 0, void 0, function* () {
         ...
         * e.g. when K = "name" | "email", getPersonCommon returns an object looking like { name, email }
         */
        this.getPerson = (accessToken) => __awaiter(this, void 0, void 0, function* () {
