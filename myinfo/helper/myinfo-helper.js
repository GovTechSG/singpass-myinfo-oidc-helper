...
class MyInfoHelper {
    constructor(props) {
        ...
        this.getToken = (authCode, state) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.post(this.tokenUrl, params, this.proxyTokenUrl);
            }
            catch (error) {
        ...
        this.getPersonCommon = (uinfin, attributes) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.get(url, params, null, proxyUrl);
            }
            catch (error) {
        ...
        this.getPerson = (accessToken, attributes) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.get(url, params, accessToken, proxyUrl);
            }
            catch (error) {
