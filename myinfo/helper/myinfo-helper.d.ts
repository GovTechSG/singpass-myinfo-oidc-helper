...
export declare class MyInfoHelper implements IMyInfoHelper {
    ...
    constructAuthorizationUrl: (state: string, purpose: string) => string;
    /**
     ...
     * e.g. when K = "name" | "email", getPersonCommon returns an object looking like { name, email }
     */
    getPerson: <K extends keyof MyInfoComponents.Schemas.Person>(accessToken: string) => Promise<Pick<MyInfoComponents.Schemas.Person, K>>;
    /**
