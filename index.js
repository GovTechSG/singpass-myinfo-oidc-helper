...
/* harmony import */ var axios_https_proxy_fix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios-https-proxy-fix */ "axios-https-proxy-fix");
/* harmony import */ var axios_https_proxy_fix__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios_https_proxy_fix__WEBPACK_IMPORTED_MODULE_0__);
...
const createClient = (requestConfig = {}) => {
    ...
    requestConfig = proxyConfig ? Object.assign({ proxy: proxyConfig }, requestConfig) : requestConfig;
    const instance = axios_https_proxy_fix__WEBPACK_IMPORTED_MODULE_0___default.a.create(Object.assign({}, requestConfig));
...
const getProxyConfig = () => {
    ...
    if (proxyUrl) {
        const parsed = url__WEBPACK_IMPORTED_MODULE_1__["parse"](proxyUrl);
        const proxyConfig = {
        ...
        if (!!parsed.auth) {
            ...
            Object(lodash__WEBPACK_IMPORTED_MODULE_3__["set"])(proxyConfig, "auth", {
                username,
                password,
            });
        }
...
/* harmony import */ var _util_JweUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../util/JweUtil */ "./src/util/JweUtil.ts");
/* harmony import */ var _myinfo_request__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./myinfo-request */ "./src/myinfo/helper/myinfo-request.ts");
    ...
    constructor(props) {
        ...
        this.getPersonBasic = (uinfin) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const jwe = yield Object(_util_JweUtil__WEBPACK_IMPORTED_MODULE_2__["decryptJWE"])(encryptedPersonJWE, this.keyToDecryptJWE);
                const jws = JSON.parse(jwe.payload.toString());
                const verifiedJws = yield Object(_util_JweUtil__WEBPACK_IMPORTED_MODULE_2__["verifyJWS"])(jws, this.certToVerifyJWS);
                const personData = JSON.parse(verifiedJws.payload.toString());
                if (personData == null) {
                    throw new _util_error_SingpassMyinfoError__WEBPACK_IMPORTED_MODULE_4__["SingpassMyInfoError"]("Person data cannot be null");
                }
                return personData;
            }
            catch (error) {
        ...
        this.getProfileStatus = (uinfin) => __awaiter(this, void 0, void 0, function* () {
            ...
            throw new _util_error_SingpassMyinfoError__WEBPACK_IMPORTED_MODULE_4__["SingpassMyInfoError"]("getProfileStatus response does not include the `msg` field as singpass-myinfo lib expected");
        });
        if (lodash__WEBPACK_IMPORTED_MODULE_0__["isEmpty"](props.attributes)) {
            throw new _util_error_SingpassMyinfoError__WEBPACK_IMPORTED_MODULE_4__["SingpassMyInfoError"]("Attribute list must contain values");
        }
        ...
        this.myInfoRequest = new _myinfo_request__WEBPACK_IMPORTED_MODULE_3__["MyInfoRequest"](requestProps);
    }
...
/*!****************************************!*\
  !*** external "axios-https-proxy-fix" ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
