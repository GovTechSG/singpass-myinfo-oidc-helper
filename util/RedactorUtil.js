...
function redactError(param) {
    ...
    if (!!(axiosError === null || axiosError === void 0 ? void 0 : axiosError.isAxiosError) && !!(axiosError === null || axiosError === void 0 ? void 0 : axiosError.response)) {
        ...
        return {
            ...
            url: exports.redactUinfin(response.config.url),
            status: response.status,
            data: exports.redactUinfin(response.data),
        };
    }
    // Regular error
    if (_.isError(param)) {
        return {
            name: param.name,
            message: exports.redactUinfin(param.message),
            stack: exports.redactUinfin(param.stack),
        };
    }
    return param;
}
