	...
	it("should generate the correct auth header", () => {
		const mockParams = {
			...
			queryParams: {
				...
				attributes:
					"name,sex,race,nationality,dob,email,mobileno,regadd,housingtype,hdbtype,marital,edulevel,assessableincome,hanyupinyinname,aliasname,hanyupinyinaliasname,marriedname,cpfcontributions,cpfbalances",
			},
