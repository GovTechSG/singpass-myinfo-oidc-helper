...
export const msCckResident5: FakeProfile = {
	...
	generate: (profileName) => {
		...
		(profile.regadd as MyInfoComponentsV4.Schemas.DataitemAddressSg).unit.value = "1041";
		(profile.regadd as MyInfoComponentsV4.Schemas.DataitemAddressSg).floor.value = "08";
		(profile.regadd as MyInfoComponentsV4.Schemas.DataitemAddressSg).block.value = "438B";
		(profile.regadd as MyInfoComponentsV4.Schemas.DataitemAddressSg).street.value = "BUKIT BATOK WEST AVENUE 8";
		(profile.regadd as MyInfoComponentsV4.Schemas.DataitemAddressSg).postal.value = "652438";
