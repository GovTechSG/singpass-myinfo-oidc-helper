import { MyInfoComponentsV4 } from "./v4/myinfo-domain";
export type V4PersonBasic = MyInfoComponentsV4.Schemas.PersonCommon & MyInfoComponentsV4.Schemas.PersonCommunityCommercial;
