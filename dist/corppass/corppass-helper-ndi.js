...
class NdiOidcHelper {
    ...
    getAccessTokenPayload(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { data: { jwks_uri } } = yield this.axiosClient.get(this.oidcConfigUrl, { headers: this.additionalHeaders });
                const { data: { keys } } = yield this.axiosClient.get(jwks_uri, { headers: this.additionalHeaders });
