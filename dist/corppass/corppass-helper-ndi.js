...
class NdiOidcHelper {
    constructor(props) {
        this.constructAuthorizationUrl = (state, nonce) => __awaiter(this, void 0, void 0, function* () {
            const { data: { authorization_endpoint } } = yield this.axiosClient.get(this.oidcConfigUrl, Object.assign({}, this.additionalHeaders));
        ...
        this.getTokens = (authCode) => __awaiter(this, void 0, void 0, function* () {
            const { data: { token_endpoint, issuer } } = yield this.axiosClient.get(this.oidcConfigUrl, Object.assign({}, this.additionalHeaders));
            const params = {
    ...
    getAccessTokenPayload(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { data: { jwks_uri } } = yield this.axiosClient.get(this.oidcConfigUrl, Object.assign({}, this.additionalHeaders));
                const { data: { keys } } = yield this.axiosClient.get(jwks_uri, Object.assign({}, this.additionalHeaders));
