...
__webpack_require__.d(personbasic_factory_namespaceObject, "sponsoredchildrecordFactory", function() { return sponsoredchildrecordFactory; });
...
// CONCATENATED MODULE: ./src/util/error/SingpassMyinfoError.ts
 ...
 */
var SingpassMyInfoError = /** @class */ (function (_super) {
    __extends(SingpassMyInfoError, _super);
    function SingpassMyInfoError(message, wrappedError) {
        var _this = _super.call(this, "[singpass-myinfo-oidc-helper] " + message) || this;
        Error.captureStackTrace(_this, SingpassMyInfoError);
        Object.setPrototypeOf(_this, SingpassMyInfoError.prototype);
        if (wrappedError) {
            _this.stack = _this.stack + "\n" + wrappedError.stack;
        }
        return _this;
    }
    return SingpassMyInfoError;
}(Error));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!jwe)
                        throw new SingpassMyInfoError("Missing JWE data.");
                    if (!decryptKey)
                        throw new SingpassMyInfoError("Missing key to decrypt JWE payload.");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!jws)
                        throw new SingpassMyInfoError("Missing JWS data.");
                    if (!verifyCert)
                        throw new SingpassMyInfoError("Missing cert to verify JWS payload.");
...
var PersonBasicFactory = new external_rosie_["Factory"]()
    ...
    .attr("sponsoredChildRecords", function () { return [sponsoredchildrecordFactory.build(), sponsoredchildrecordFactory.build()]; })
...
var sponsoredchildrecordFactory = new external_rosie_["Factory"]()
    .sequence("birthcertno", function (i) { return ({
    "value": "S556288" + i,
}); })
    .sequence("name", function (i) { return ({
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/BaseProfile.ts
...
var BaseProfile = {
    ...
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? "" : profileName;
        return {
            name: {
                lastupdated: "2018-06-01",
                source: "1",
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/sponsoredChildBirthRecords.ts
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/mrSGFatherSponsoredChildrenOnly.ts




var mrSGFatherSponsoredChildrenOnly_id = "S9116045E";
var mrSGFatherSponsoredChildrenOnly_name = ProfileArchetype.MR_SG_FATHER_ONLY_SPONSORED;
var mrSGFatherSponsoredChildrenOnly = {
    id: mrSGFatherSponsoredChildrenOnly_id,
    name: mrSGFatherSponsoredChildrenOnly_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGFatherSponsoredChildrenOnly_name : profileName;
        var profile = BaseProfile.generate(profileName);
        profile.sponsoredchildrenrecords = external_lodash_["values"](SponsoredChildrenRecords);
        return profile;
    },
};
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario1a.ts



var mrGSTVUncleScenario1a_id = "S1234567D";
var mrGSTVUncleScenario1a_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_1A;
var mrGstvUncle1a = {
    id: mrGSTVUncleScenario1a_id,
    name: mrGSTVUncleScenario1a_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario1a_name : profileName;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario1a2.ts



var mrGSTVUncleScenario1a2_id = "S1234567D";
var mrGSTVUncleScenario1a2_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_1A2;
var mrGstvUncle1a2 = {
    id: mrGSTVUncleScenario1a2_id,
    name: mrGSTVUncleScenario1a2_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario1a2_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
        profile.gstvoucher.signup.value = true;
        profile.gstvoucher.gstregular.value = 100;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario1b.ts



var mrGSTVUncleScenario1b_id = "S1234567D";
var mrGSTVUncleScenario1b_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_1B;
var mrGstvUncle1b = {
    id: mrGSTVUncleScenario1b_id,
    name: mrGSTVUncleScenario1b_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario1b_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
        profile.gstvoucher.signup.value = true;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario2a.ts



var mrGSTVUncleScenario2a_id = "S1234567D";
var mrGSTVUncleScenario2a_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_2A;
var mrGstvUncle2a = {
    id: mrGSTVUncleScenario2a_id,
    name: mrGSTVUncleScenario2a_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario2a_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario2a2.ts



var mrGSTVUncleScenario2a2_id = "S1234567D";
var mrGSTVUncleScenario2a2_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_2A2;
var mrGstvUncle2a2 = {
    id: mrGSTVUncleScenario2a2_id,
    name: mrGSTVUncleScenario2a2_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario2a2_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
        profile.gstvoucher.signup.value = false;
        profile.gstvoucher.gstregular.value = 0;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario2a3.ts



var mrGSTVUncleScenario2a3_id = "S1234567D";
var mrGSTVUncleScenario2a3_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_2A3;
var mrGstvUncle2a3 = {
    id: mrGSTVUncleScenario2a3_id,
    name: mrGSTVUncleScenario2a3_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario2a3_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
        profile.gstvoucher.signup.value = false;
        profile.gstvoucher.gstregular.value = 100;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario2b.ts



var mrGSTVUncleScenario2b_id = "S1234567D";
var mrGSTVUncleScenario2b_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_2B;
var mrGstvUncle2b = {
    id: mrGSTVUncleScenario2b_id,
    name: mrGSTVUncleScenario2b_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario2b_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = false;
        profile.gstvoucher.signup.value = false;
        profile.gstvoucher.gstregular.value = 0;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario3.ts



var mrGSTVUncleScenario3_id = "S1234567D";
var mrGSTVUncleScenario3_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_3;
var mrGstvUncle3 = {
    id: mrGSTVUncleScenario3_id,
    name: mrGSTVUncleScenario3_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario3_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrGSTVUncleScenario4.ts



var mrGSTVUncleScenario4_id = "S1234567D";
var mrGSTVUncleScenario4_name = ProfileArchetype.MR_SG_UNCLE_GST_SCENARIO_4;
var mrGstvUncle4 = {
    id: mrGSTVUncleScenario4_id,
    name: mrGSTVUncleScenario4_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrGSTVUncleScenario4_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.gstvoucher.exclusion.value = true;
        profile.gstvoucher.signup.value = false;
        profile.gstvoucher.gstregular.value = 100;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrMYDadJobless.ts



var mrMYDadJobless_id = "G9403340W";
var mrMYDadJobless_name = ProfileArchetype.MR_MY_DAD_JOBLESS;
var mrMYDadJobless = {
    id: mrMYDadJobless_id,
    name: mrMYDadJobless_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrMYDadJobless_name : profileName;
        var profile = mrMYDaddyPerfect.generate(profileName);
        profile.occupation = {
            "lastupdated": null,
            "code": null,
            "source": null,
...
var childbirthRecords_formatDateToString = function (date) {
    if (date) {
        return date.format("YYYY-MM-DD").toString();
    }
    return external_moment_().format("YYYY-MM-DD").toString();
};
var childbirthRecords_childYoungest = {
    birthcertno: { value: "T1828432J" },
    name: { value: "Youngest Tan Ke Xuan" },
    dob: { value: childbirthRecords_formatDateToString() },
};
var childbirthRecords_child1MonthOld = {
    birthcertno: { value: "T4383608G" },
    name: { value: "1 Month Tan Ke Yu" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(1, "months")) },
};
var childbirthRecords_child2MonthsOld = {
    birthcertno: { value: "T7153144E" },
    name: { value: "2 Months Tan Keh Guan" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(2, "months")) },
};
var childbirthRecords_childMiddle1 = {
    birthcertno: { value: "T1694727F" },
    name: { value: "Middle Tan Twin1" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(2, "years")) },
};
var childbirthRecords_childMiddle2 = {
    birthcertno: { value: "T1669632Z" },
    name: { value: "Middle Tan Twin2" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(2, "years")) },
};
var childbirthRecords_childMiddle3 = {
    birthcertno: { value: "T1509027D" },
    name: { value: "Tan Boy" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(3, "years")) },
};
var childbirthRecords_childMiddle4 = {
    birthcertno: { value: "T1422931G" },
    name: { value: "Tan Girl" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(4, "years")) },
};
var childbirthRecords_childMiddle5 = {
    birthcertno: { value: "T1511326F" },
    name: { value: "Tan Girl Younger" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(5, "years")) },
};
var childbirthRecords_childSuperOld = {
    birthcertno: { value: "T0050832I" },
    name: { value: "Super Old Tan Ke Wei" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(8, "years")) },
};
var childbirthRecords_child6YearsOld = {
    birthcertno: { value: "T1364674G" },
    name: { value: "Turning 6 Tan Kid born Jan 1st" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(6, "years").startOf("year")) },
};
var childbirthRecords_child7YearsOld = {
    birthcertno: { value: "T1210114C" },
    name: { value: "Turning 7 Tan Kid born Dec 31" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(7, "years").endOf("year")) },
};
var childDeceased1 = {
    birthcertno: { value: "T0492081Z" },
    name: { value: "Deceased child 1" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(4, "years").endOf("year")) },
    lifestatus: { code: "D", desc: "DECEASED" },
};
var childDeceased2 = {
    birthcertno: { value: "T1756880E" },
    name: { value: "Deceased child 2" },
    dob: { value: childbirthRecords_formatDateToString(external_moment_().subtract(5, "years").endOf("year")) },
    lifestatus: { code: "D", desc: "DECEASED" },
};
var ChildrenRecords = {
    childYoungest: childbirthRecords_childYoungest,
    child1MonthOld: childbirthRecords_child1MonthOld,
    child2MonthsOld: childbirthRecords_child2MonthsOld,
    childMiddle1: childbirthRecords_childMiddle1,
    childMiddle2: childbirthRecords_childMiddle2,
    childMiddle3: childbirthRecords_childMiddle3,
    childMiddle4: childbirthRecords_childMiddle4,
    childMiddle5: childbirthRecords_childMiddle5,
    childSuperOld: childbirthRecords_childSuperOld,
    child6YearsOld: childbirthRecords_child6YearsOld,
    child7YearsOld: childbirthRecords_child7YearsOld,
    childDeceased1: childDeceased1,
    childDeceased2: childDeceased2,
};
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrPRJobless.ts




var mrPRJobless_id = "S2599302J";
var mrPRJobless_name = ProfileArchetype.MR_PR_JOBLESS;
var mrPRJobless = {
    id: mrPRJobless_id,
    name: mrPRJobless_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrPRJobless_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.nationality.code = "AD";
        profile.residentialstatus.code = "P";
        profile.residentialstatus.desc = residentialstatus.map.codeToDesc[profile.residentialstatus.code];
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGDaddyTwoDeceasedChild.ts




var mrSGDaddyTwoDeceasedChild_id = "S4315482F";
var mrSGDaddyTwoDeceasedChild_name = ProfileArchetype.MR_SG_DADDY_TWO_DECEASED_CHILD;
var mrSGDaddyTwoDeceasedChild = {
    id: mrSGDaddyTwoDeceasedChild_id,
    name: mrSGDaddyTwoDeceasedChild_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGDaddyTwoDeceasedChild_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGJobless.ts



var mrSGJobless_id = "S8399420G";
var mrSGJobless_name = ProfileArchetype.MR_SG_JOBLESS;
var mrSGJobless = {
    id: mrSGJobless_id,
    name: mrSGJobless_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGJobless_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.occupation = {
            "lastupdated": null,
            "code": null,
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleMgAllOk.ts



var mrSGUncleMgAllOk_id = "S8399420G";
var mrSGUncleMgAllOk_name = ProfileArchetype.MR_SG_UNCLE_MG_ALL_OK;
var mrSGUncleMgAllOk = {
    id: mrSGUncleMgAllOk_id,
    name: mrSGUncleMgAllOk_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleMgAllOk_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleMgCallReceive.ts



var mrSGUncleMgCallReceive_id = "S8399420G";
var mrSGUncleMgCallReceive_name = ProfileArchetype.MR_SG_UNCLE_MG_CALL_RECEIVE;
var mrSGUncleMgCallReceive = {
    id: mrSGUncleMgCallReceive_id,
    name: mrSGUncleMgCallReceive_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleMgCallReceive_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleMgNeedMedisave.ts



var mrSGUncleMgNeedMedisave_id = "S8399420G";
var mrSGUncleMgNeedMedisave_name = ProfileArchetype.MR_SG_UNCLE_MG_NEED_MEDISAVE;
var mrSGUncleMgNeedMedisave = {
    id: mrSGUncleMgNeedMedisave_id,
    name: mrSGUncleMgNeedMedisave_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleMgNeedMedisave_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleMgNilStatus.ts



var mrSGUncleMgNilStatus_id = "S8399420G";
var mrSGUncleMgNilStatus_name = ProfileArchetype.MR_SG_UNCLE_MG_NIL_STATUS;
var mrSGUncleMgNilStatus = {
    id: mrSGUncleMgNilStatus_id,
    name: mrSGUncleMgNilStatus_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleMgNilStatus_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleNonBenefits.ts



var mrSGUncleNonBenefits_id = "S8399420G";
var mrSGUncleNonBenefits_name = ProfileArchetype.MR_SG_UNCLE_NON_BENEFITS;
var mrSGUncleNonBenefits = {
    id: mrSGUncleNonBenefits_id,
    name: mrSGUncleNonBenefits_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleNonBenefits_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleNonMg.ts



var mrSGUncleNonMg_id = "S8399420G";
var mrSGUncleNonMg_name = ProfileArchetype.MR_SG_UNCLE_NON_MG;
var mrSGUncleNonMg = {
    id: mrSGUncleNonMg_id,
    name: mrSGUncleNonMg_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleNonMg_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.merdekagen.message.code = "1";
        profile.merdekagen.eligibility.value = false;
        return profile;
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGUncleOptOut.ts



var mrSGUncleOptOut_id = "S8399420G";
var mrSGUncleOptOut_name = ProfileArchetype.MR_SG_UNCLE_OPT_OUT;
var mrSGUncleOptOut = {
    id: mrSGUncleOptOut_id,
    name: mrSGUncleOptOut_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGUncleOptOut_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrsMYMomJobless.ts




var mrsMYMomJobless_id = "G9403340W";
var mrsMYMomJobless_name = ProfileArchetype.MRS_MY_MOM_JOBLESS;
var mrsMYMomJobless = {
    id: mrsMYMomJobless_id,
    name: mrsMYMomJobless_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrsMYMomJobless_name : profileName;
        var profile = mrsMYMommyPerfect.generate(profileName);
        profile.occupation = {
            "lastupdated": null,
            "code": null,
            "source": null,
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/normalChildren.ts

var normalChildren_formatDateToString = function (date) {
    if (date) {
        return date.format("YYYY-MM-DD").toString();
    }
    return external_moment_().format("YYYY-MM-DD").toString();
};
var normalChildren_childYoungest = {
    birthcertno: { value: "S1915980I" },
    name: { value: "Tan Ke Xuan" },
    dob: { value: normalChildren_formatDateToString() },
};
var normalChildren_child1MonthOld = {
    birthcertno: { value: "S1985973H" },
    name: { value: "Tan Ke Yu" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(1, "months")) },
};
var normalChildren_child2MonthsOld = {
    birthcertno: { value: "S1934480J" },
    name: { value: "Tan Keh Guan" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(2, "months")) },
};
var normalChildren_childMiddle1 = {
    birthcertno: { value: "S7337031J" },
    name: { value: "Tan Chiu" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(2, "years")) },
};
var normalChildren_childMiddle2 = {
    birthcertno: { value: "S0836115J" },
    name: { value: "Tan Chua" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(2, "years")) },
};
var normalChildren_childMiddle3 = {
    birthcertno: { value: "S3159159G" },
    name: { value: "Tan Su" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(3, "years")) },
};
var normalChildren_childMiddle4 = {
    birthcertno: { value: "S0758717A" },
    name: { value: "Tan Go" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(4, "years")) },
};
var normalChildren_childMiddle5 = {
    birthcertno: { value: "S4886773A" },
    name: { value: "Tan Sy" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(5, "years")) },
};
var normalChildren_child6YearsOld = {
    birthcertno: { value: "S8767263H" },
    name: { value: "Tan Kim" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(6, "years").startOf("year")) },
};
var normalChildren_child7YearsOld = {
    birthcertno: { value: "S8359810G" },
    name: { value: "Tan Liu" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(7, "years").endOf("year")) },
};
var normalChildren_childSuperOld = {
    birthcertno: { value: "S6680318Z" },
    name: { value: "Tan Ke Wei" },
    dob: { value: normalChildren_formatDateToString(external_moment_().subtract(8, "years")) },
};
var Childrenbirthrecords = {
    childYoungest: normalChildren_childYoungest,
    child1MonthOld: normalChildren_child1MonthOld,
    child2MonthsOld: normalChildren_child2MonthsOld,
    childMiddle1: normalChildren_childMiddle1,
    childMiddle2: normalChildren_childMiddle2,
    childMiddle3: normalChildren_childMiddle3,
    childMiddle4: normalChildren_childMiddle4,
    childMiddle5: normalChildren_childMiddle5,
    child6YearsOld: normalChildren_child6YearsOld,
    child7YearsOld: normalChildren_child7YearsOld,
    childSuperOld: normalChildren_childSuperOld,
};

// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/mrSGFatherNormalChildrenOnly.ts




var mrSGFatherNormalChildrenOnly_id = "S9116045E";
var mrSGFatherNormalChildrenOnly_name = ProfileArchetype.MR_SG_FATHER_NORMAL_CHILDREN;
var mrSGFatherNormalChildrenOnly = {
    id: mrSGFatherNormalChildrenOnly_id,
    name: mrSGFatherNormalChildrenOnly_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGFatherNormalChildrenOnly_name : profileName;
        var profile = BaseProfile.generate(profileName);
        profile.childrenbirthrecords = external_lodash_["values"](Childrenbirthrecords);
        return profile;
    },
};

// CONCATENATED MODULE: ./src/myinfo/fake/profiles/sponsored-children/msSGMotherBothChildren.ts





var msSGMotherBothChildren_id = "S9116045E";
var msSGMotherBothChildren_name = ProfileArchetype.MS_SG_MOTHER_HAVING_BOTH_CHILDREN;
var msSGMotherBothChildren = {
    id: msSGMotherBothChildren_id,
    name: msSGMotherBothChildren_name,
    // tslint:disable-next-line: no-big-function
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? msSGMotherBothChildren_name : profileName;
        var profile = BaseProfile.generate(profileName);
        profile.sex.code = "F";
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrSGNoLocalAddress .ts



var mrSGNoLocalAddress_id = "S4875477E";
var mrSGNoLocalAddress_name = ProfileArchetype.MR_SG_NO_LOCAL_ADDRESS;
var mrSGNoLocalAddress = {
    id: mrSGNoLocalAddress_id,
    name: mrSGNoLocalAddress_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrSGNoLocalAddress_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.regadd = {
            "type": "Unformatted",
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrPRNoLocalAddress.ts




var mrPRNoLocalAddress_id = "S3814379D";
var mrPRNoLocalAddress_name = ProfileArchetype.MR_PR_NO_LOCAL_ADDRESS;
var mrPRNoLocalAddress = {
    id: mrPRNoLocalAddress_id,
    name: mrPRNoLocalAddress_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrPRNoLocalAddress_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.nationality.code = "AD";
        profile.residentialstatus.code = "P";
        profile.residentialstatus.desc = residentialstatus.map.codeToDesc[profile.residentialstatus.code];
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrJapaneseAddressBlank.ts



var mrJapaneseAddressBlank_id = "F5316757T";
var mrJapaneseAddressBlank_name = ProfileArchetype.MR_JAPANESE_ADDRESS_BLANK;
var mrJapaneseAddressBlank = {
    id: mrJapaneseAddressBlank_id,
    name: mrJapaneseAddressBlank_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrJapaneseAddressBlank_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
...
// CONCATENATED MODULE: ./src/myinfo/fake/profiles/mrJapaneseNoAddressObject.ts



var mrJapaneseNoAddressObject_id = "F2734981K";
var mrJapaneseNoAddressObject_name = ProfileArchetype.MR_JAPANESE_NO_ADDRESS_OBJECT;
var mrJapaneseNoAddressObject = {
    id: mrJapaneseNoAddressObject_id,
    name: mrJapaneseNoAddressObject_name,
    generate: function (profileName) {
        profileName = external_lodash_["isEmpty"](profileName) ? mrJapaneseNoAddressObject_name : profileName;
        var profile = mrSGDaddyPerfect.generate(profileName);
        profile.residentialstatus = {
            "code": "",
            "desc": "",
...
var fake_helper_FakeMyInfoHelper = /** @class */ (function () {
    ...
    function FakeMyInfoHelper(attributes) {
        ...
        this.getPersonBasic = function (mockParams) {
            ...
            if (!Object(external_lodash_["isEmpty"])(mockParams.residentialstatus)) {
                myinfoPerson.residentialstatus.code = mockParams.residentialstatus;
                myinfoPerson.residentialstatus.desc = map_namespaceObject.residentialstatus.map.codeToDesc[mockParams.residentialstatus];
            }
            ...
            if (!Object(external_lodash_["isEmpty"])(mockParams.gstvyear)) {
                myinfoPerson.gstvoucher.year.value = mockParams.gstvyear;
            }
            if (!Object(external_lodash_["isEmpty"])(mockParams.gvs)) {
...
function filterThroughMyInfoAttributes(person, attributes) {
    var _a = Object(external_lodash_["partition"])(attributes, function (value) { return value.startsWith("childrenbirthrecords."); }), childrenRawCbrAttributes = _a[0], childrenNormalAttributes = _a[1];
    var _b = Object(external_lodash_["partition"])(attributes, function (value) { return value.startsWith("sponsoredchildrenrecords."); }), sponsoredRawCbrAttributes = _b[0], sponsoredNormalAttributes = _b[1];
    var childrenFilteredPerson = filterThroughAttributes(person, childrenNormalAttributes);
    var sponsoredFilteredPerson = filterThroughAttributes(person, sponsoredNormalAttributes);
    if (childrenRawCbrAttributes.length > 0) {
        var childrenbirthrecordsAttributes_1 = Object(external_lodash_["map"])(childrenRawCbrAttributes, function (cbrAttribute) { return cbrAttribute.split(".")[1]; });
        ...
        Object(external_lodash_["set"])(childrenFilteredPerson, "childrenbirthrecords", filteredChildrenbirthrecords);
    }
    if (sponsoredRawCbrAttributes.length > 0) {
        var sponsoredBirthrecordsAttributes_1 = Object(external_lodash_["map"])(sponsoredRawCbrAttributes, function (cbrAttribute) { return cbrAttribute.split(".")[1]; });
        // get filtered childrenbirthrecords
        var filteredSponsoredChildrenbirthrecords = Object(external_lodash_["map"])(person.sponsoredchildrenrecords, function (cbr) { return filterThroughAttributes(cbr, sponsoredBirthrecordsAttributes_1); });
        Object(external_lodash_["set"])(sponsoredFilteredPerson, "sponsoredchildrenrecords", filteredSponsoredChildrenbirthrecords);
    }
    return fake_helper_assign({}, childrenFilteredPerson, sponsoredFilteredPerson);
}
...
var singpass_helper_OidcHelper = /** @class */ (function () {
    ...
    OidcHelper.prototype.logoutOfSession = function (sessionId) {
        return singpass_helper_awaiter(this, void 0, void 0, function () {
            var requestConfig, e_2;
            return singpass_helper_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (Object(external_lodash_["isNil"])(this.logoutUrl)) {
                    ...
                    case 3:
                        e_2 = _a.sent();
                        Logger.warn("Singpass Error while attempting to logout of Singpass session", e_2);
