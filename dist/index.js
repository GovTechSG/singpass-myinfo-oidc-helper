...
__webpack_require__.d(myinfo_namespaceObject, "domain", function() { return domain; });
...
var external_nonce_ = __webpack_require__(5);
...
var external_is_base64_ = __webpack_require__(6);
...
function generateSignature(authHeader, queryParams, method, url, key, keyPassphrase) {
    ...
    var sortedListOfKeysForBaseString = ["app_id", "attributes", "client_id", "nonce", "signature_method", "sp_esvcId", "timestamp"];
    var sortedParams = sortedListOfKeysForBaseString.reduce(function (object, prop) {
        return external_lodash_["set"](object, prop, baseParams[prop]);
    }, {});
...
var external_axios_https_proxy_fix_ = __webpack_require__(8);
...
// EXTERNAL MODULE: ./src/myinfo/domain/domain.ts
    ...
    function FakeMyInfoHelper(attributes) {
        ...
        this.getPersonBasic = function (mockParams) {
            ...
            if (!Object(external_lodash_["isEmpty"])(mockParams.marital)) {
                ...
                myinfoPerson.marital.code = map_namespaceObject.sex.map.descToCode[mockParams.marital];
            }
...
function filterThroughMyInfoAttributes(person, attributes) {
    ...
    return Object(external_lodash_["toPairs"])(person)
        .filter(function (_a) {
        var k = _a[0];
        return attrs.has(k);
    })
