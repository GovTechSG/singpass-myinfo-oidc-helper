...
class MyInfoHelper {
    constructor(props) {
        ...
        this.getToken = (authCode, state) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.post(this.tokenUrl, params, this.proxyTokenUrl, this.additionalHeaders);
            }
            catch (error) {
         ...
         */
        this.getPersonBasic = (uinfin, attributes) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.get(url, params, null, proxyUrl, this.additionalHeaders);
            }
            catch (error) {
        ...
        this.getPerson = (accessToken, attributes) => __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.myInfoRequest.get(url, params, accessToken, proxyUrl, this.additionalHeaders);
            }
            catch (error) {
        ...
        this.getProfileStatus = (uinfin) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.myInfoRequest.get(url, null, null, proxyUrl, this.additionalHeaders);
