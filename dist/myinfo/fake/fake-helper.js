...
class FakeMyInfoHelper {
    ...
    constructor(attributes) {
        ...
        this.getPersonInfo = (mockParams) => {
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.passtype)) {
                ...
                myinfoPerson.passtype.desc = domain_1.MyInfoPassTypeCode.fn.toEnumDesc(mockParams.passtype);
            }
    ...
    checkIsSingaporeanOrPr(residentialStatusValue) {
        return (residentialStatusValue === domain_1.MyInfoResidentialCode.CITIZEN ||
            residentialStatusValue === domain_1.MyInfoResidentialCode.PR);
    }
}
...
function transformChildBirthRecord(childbirthrecord, index) {
    return {
        ...
        lifestatus: {
            ...
            desc: domain_1.MyInfoLifeStatusCode.fn.toEnumDesc(childbirthrecord.lifestatus),
        },
