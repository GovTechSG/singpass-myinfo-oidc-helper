...
exports.transformItemsWithAdditionalMock = exports.transformItems = exports.transformChildBirthRecord = exports.FakeMyInfoHelper = exports.OverrideMode = void 0;
...
class FakeMyInfoHelper {
    ...
    constructor(attributes) {
        ...
        this.getPersonInfo = (mockParams) => {
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.occupation)) {
                // only fin users have value
                if (!this.checkIsSingaporeanOrPr(myinfoPerson.residentialstatus.code)) {
                    myinfoPerson.occupation.value = domain_1.MyInfoOccupationCode.fn.toEnumDesc(mockParams.occupation);
                }
                else {
                ...
                if (!(0, lodash_1.isEmpty)(mockParams.occupationfreeform)) {
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.vehiclestatus)) {
