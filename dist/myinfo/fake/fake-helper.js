...
class FakeMyInfoHelper {
    ...
    constructor(attributes) {
        ...
        this.getPersonInfo = (mockParams) => {
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.residentialstatus)) {
                ...
                myinfoPerson.residentialstatus.desc = types_1.MyInfoResidentialCode.fn.toEnumDesc(mockParams.residentialstatus);
            }
            if (!(0, lodash_1.isEmpty)(mockParams.marital)) {
                myinfoPerson.marital.code = mockParams.marital;
                myinfoPerson.marital.desc = types_1.MyInfoMaritalStatusCode.fn.toEnumDesc(mockParams.marital);
            }
            if (!(0, lodash_1.isEmpty)(mockParams.passtype)) {
                myinfoPerson.passtype.code = mockParams.passtype;
                myinfoPerson.passtype.desc = types_1.MyInfoPassTypeCode.fn.toEnumDesc(mockParams.passtype);
            }
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.countryofmarriage)) {
                ...
                myinfoPerson.countryofmarriage.desc = types_1.MyInfoCountryPlaceCode.fn.toEnumDesc(mockParams.countryofmarriage);
            }
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.regadd)) {
                ...
                if (mockParams.regadd.type === "SG") {
                    ...
                    myinfoPerson.regadd = {
                        ...
                        building: {
                            value: !(0, lodash_1.isEmpty)(mockParams.regadd.building)
                        ...
                        postal: {
                            value: !(0, lodash_1.isEmpty)(mockParams.regadd.postal) ? mockParams.regadd.postal : regadd.postal.value,
                        },
                        street: {
                            value: !(0, lodash_1.isEmpty)(mockParams.regadd.street) ? mockParams.regadd.street : regadd.street.value,
                        },
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.hdbtype)) {
                myinfoPerson.hdbtype = {
                    ...
                    desc: types_1.MyInfoHDBTypeCode.fn.toEnumDesc(mockParams.hdbtype),
                    unavailable: false,
                };
                ...
                myinfoPerson.housingtype = {
                    ...
                    desc: types_1.MyInfoHousingTypeCode.fn.toEnumDesc(mockParams.housingtype),
                    unavailable: false,
                };
                myinfoPerson.hdbtype = {
                    lastupdated: "2020-08-26",
                ...
                myinfoPerson.drivinglicence = {
                    ...
                    qdl: {
                        ...
                        validity: {
                            ...
                            desc: types_1.MyInfoDrivingLicenceValidityCode.fn.toEnumDesc(mockParams.drivingqdlvalidity),
                        },
                        classes: [
                            {
                                class: {
                    ...
                    classification: "C",
                    comstatus: {
                        code: types_1.MyInfoComStatusCode.ELIGIBLE,
                        desc: types_1.MyInfoComStatusCode.fn.toEnumDesc(types_1.MyInfoComStatusCode.ELIGIBLE),
                    },
                    photocardserialno: {
                        value: null,
                    },
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.vehicles)) {
                myinfoPerson.vehicles = mockParams.vehicles.map((vehicle) => {
                    return {
                        ...
                        status: {
                            code: vehicle.status,
                            desc: types_1.MyInfoVehicleStatus.fn.toEnumDesc(vehicle.status),
                        },
                        unavailable: false,
                    };
                });
            ...
            if (!(0, lodash_1.isEmpty)(mockParams.childrenbirthrecords)) {
                ...
                switch (mockParams.childrenoverridemode) {
                    ...
                    case types_2.OverrideMode.partial:
                        ...
                        break;
                    case types_2.OverrideMode.full:
                        myinfoPerson.childrenbirthrecords = childrenBirthRecords;
                        break;
                }
            }
            if (!(0, lodash_1.isEmpty)(mockParams.race)) {
                ...
                myinfoPerson.race.desc = types_1.MyInfoRaceCode.fn.toEnumDesc(mockParams.race);
            }
            if (!(0, lodash_1.isEmpty)(mockParams.email)) {
                myinfoPerson.email.unavailable = false;
                myinfoPerson.email.value = mockParams.email;
            }
            if (!(0, lodash_1.isEmpty)(mockParams.mobileno)) {
        ...
        this.getPerson = (mockParams) => {
            ...
            if (((_a = mockParams.cpfbalances) === null || _a === void 0 ? void 0 : _a.ma) ||
                ((_b = mockParams.cpfbalances) === null || _b === void 0 ? void 0 : _b.oa) ||
                ((_c = mockParams.cpfbalances) === null || _c === void 0 ? void 0 : _c.ra) ||
                ((_d = mockParams.cpfbalances) === null || _d === void 0 ? void 0 : _d.sa)) {
    ...
    checkIsSingaporeanOrPr(residentialStatusValue) {
        return (residentialStatusValue === types_1.MyInfoResidentialCode.CITIZEN ||
            residentialStatusValue === types_1.MyInfoResidentialCode.PR);
    }
}
...
function transformChildBirthRecord(childbirthrecord, index) {
    return {
        ...
        sex: { code: childbirthrecord.sex, desc: types_1.MyInfoSexCode.fn.toEnumDesc(childbirthrecord.sex) },
        lifestatus: {
            code: childbirthrecord.lifestatus,
            desc: types_1.MyInfoLifeStatusCode.fn.toEnumDesc(childbirthrecord.lifestatus),
        },
        ...
        ...(childbirthrecord.race
            ? { race: { code: childbirthrecord.race, desc: types_1.MyInfoRaceCode.fn.toEnumDesc(childbirthrecord.race) } }
            : undefined),
        ...(childbirthrecord.secondaryrace
            ? {
                secondaryrace: {
                    code: childbirthrecord.secondaryrace,
                    desc: types_1.MyInfoRaceCode.fn.toEnumDesc(childbirthrecord.secondaryrace),
                },
            }
            : undefined),
        unavailable: false,
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function transformItemsWithAdditionalMock(item) {
