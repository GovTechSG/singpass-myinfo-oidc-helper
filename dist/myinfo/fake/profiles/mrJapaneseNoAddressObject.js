...
exports.mrJapaneseNoAddressObject = {
    ...
    generate: (profileName) => {
        ...
        profile.occupation = {
            ...
            "source": "2",
            "classification": "C",
            "value": domain_1.MyInfoOccupationCode.fn.toEnumDesc(domain_1.MyInfoOccupationCode.OTHER_SPECIALIST_MEDICAL_PRACTITIONERS_MEDICAL_EG_ENDOCRINOLOGIST_GERIATRICIAN_HAEMATOLOGIST_INFECTIOUS_DISEASES_PHYSICIAN_NEUROLOGIST_NUCLEAR_MEDICINE_PHYSICIAN_REHABILITATION_PHYSICIAN_RENAL_PHYSICIAN_RHEUMATOLOGIST),
        };
        profile.dialect = {
            "lastupdated": "2020-09-10",
            "code": "",
