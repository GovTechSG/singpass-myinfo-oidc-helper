...
exports.mrSGUnclePgNeedMedisave = {
    ...
    generate: (profileName) => {
        ...
        profile.pioneergen.message.code = types_1.MyInfoPioneerGenerationMessageCode.NEED_MEDISAVE_TOPUP;
        profile.pioneergen.message.desc = types_1.MyInfoPioneerGenerationMessageCode.fn.toEnumDesc(types_1.MyInfoPioneerGenerationMessageCode.NEED_MEDISAVE_TOPUP);
        return profile;
    },
};
