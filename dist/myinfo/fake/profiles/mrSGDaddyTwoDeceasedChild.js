...
exports.mrSGDaddyTwoDeceasedChild = {
    ...
    generate: (profileName) => {
        ...
        profile.childrenbirthrecords = [
            childbirthRecords_1.ChildrenRecords.child2MonthsOld,
            childbirthRecords_1.ChildrenRecords.childDeceased1,
            childbirthRecords_1.ChildrenRecords.childDeceased2,
        ];
        return profile;
    },
};
