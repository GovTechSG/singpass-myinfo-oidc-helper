...
const mrAmktcResident1_1 = require("./mrAmktcResident1");
const mrAmktcResident2_1 = require("./mrAmktcResident2");
const mrAmktcResident3_1 = require("./mrAmktcResident3");
const mrAmktcResident4_1 = require("./mrAmktcResident4");
const mrAmktcResident5_1 = require("./mrAmktcResident5");
...
const mrJeTcResident_1 = require("./mrJeTcResident");
const mrJyTcResident_1 = require("./mrJyTcResident");
const mrMpbhtcResident1_1 = require("./mrMpbhtcResident1");
const mrMpbhtcResident2_1 = require("./mrMpbhtcResident2");
const mrMpbhtcResident3_1 = require("./mrMpbhtcResident3");
const mrMpbhtcResident4_1 = require("./mrMpbhtcResident4");
const mrMpbhtcResident5_1 = require("./mrMpbhtcResident5");
const mrMpbhtcResident6_1 = require("./mrMpbhtcResident6");
...
const mrMpTcResident_1 = require("./mrMpTcResident");
...
const mrPuTcResident_1 = require("./mrPuTcResident");
const mrsAmktcResident6_1 = require("./mrsAmktcResident6");
...
const mrSgNoEmailNoMobileNoRegadd_1 = require("./mrSgNoEmailNoMobileNoRegadd");
...
const mrTeTcResident_1 = require("./mrTeTcResident");
const mrWaTCResident_1 = require("./mrWaTCResident");
...
exports.profiles = [
    ...
    mrSgNoEmailNoMobileNoRegadd_1.mrSgNoEmailNoMobileNoRegadd,
    ...
    mrPuTcResident_1.mrPuTcResident,
    mrJyTcResident_1.mrJyTcResident,
    mrTeTcResident_1.mrTeTcResident,
    mrWaTCResident_1.mrWaTcResident,
    mrJeTcResident_1.mrJeTcResident,
    mrMpTcResident_1.mrMpTcResident,
    mrAmktcResident1_1.mrAmktcResident1,
    mrAmktcResident2_1.mrAmktcResident2,
    mrAmktcResident3_1.mrAmktcResident3,
    mrAmktcResident4_1.mrAmktcResident4,
    mrAmktcResident5_1.mrAmktcResident5,
    mrsAmktcResident6_1.mrsAmktcResident6,
    mrMpbhtcResident1_1.mrMpbhtcResident1,
    mrMpbhtcResident2_1.mrMpbhtcResident2,
    mrMpbhtcResident3_1.mrMpbhtcResident3,
    mrMpbhtcResident4_1.mrMpbhtcResident4,
    mrMpbhtcResident5_1.mrMpbhtcResident5,
    mrMpbhtcResident6_1.mrMpbhtcResident6,
];
