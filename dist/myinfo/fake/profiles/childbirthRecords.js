...
const childDeceased1 = {
    ...
    dob: { value: formatDateToString(util_1.DateUtils.endOfYear(core_1.ZonedDateTime.now().minusYears(4))) },
    sex: { code: types_1.MyInfoSexCode.MALE, desc: types_1.MyInfoSexCode.fn.toEnumDesc(types_1.MyInfoSexCode.MALE) },
    tob: { value: "2200" },
    lifestatus: {
        code: types_1.MyInfoLifeStatusCode.DECEASED,
        desc: types_1.MyInfoLifeStatusCode.fn.toEnumDesc(types_1.MyInfoLifeStatusCode.DECEASED),
    },
    unavailable: false,
};
const childDeceased2 = {
    ...
    dob: { value: formatDateToString(util_1.DateUtils.endOfYear(core_1.ZonedDateTime.now().minusYears(5))) },
    sex: { code: types_1.MyInfoSexCode.FEMALE, desc: types_1.MyInfoSexCode.fn.toEnumDesc(types_1.MyInfoSexCode.FEMALE) },
    tob: { value: "2200" },
    lifestatus: {
        code: types_1.MyInfoLifeStatusCode.DECEASED,
