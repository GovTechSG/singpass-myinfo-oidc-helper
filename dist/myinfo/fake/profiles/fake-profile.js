...
(function (ProfileArchetype) {
    ...
    // For BRV2 ICA UAT
    ProfileArchetype["MR_ICA_SG_DADDY_SPOUSE_SCENARIO_1"] = "Mr SG Daddy Spouse Applicant Scenario 1 No Audit Required";
    ProfileArchetype["MRS_ICA_SG_MOMMY_MAIN_SCENARIO_1"] = "Mrs SG Mommy Main Applicant Scenario 1 No Audit Required";
    ProfileArchetype["MR_ICA_PR_DADDY_SPOUSE_SCENARIO_2"] = "Mr PR Daddy Spouse Applicant Scenario 2 Verify Marriage Required";
    ProfileArchetype["MRS_ICA_SG_MOMMY_MAIN_SCENARIO_2"] = "Mrs SG Mommy Main Applicant Scenario 2 Verify Marriage Required";
    ProfileArchetype["MR_ICA_SG_DADDY_MAIN_SCENARIO_3"] = "Mr SG Daddy Main Applicant Scenario 3 Marriage Info Mismatch Audit Required";
    ProfileArchetype["MRS_ICA_PR_MOMMY_SPOUSE_SCENARIO_3"] = "Mrs PR Mommy Spouse Applicant Scenario 3 Marriage Info Mismatch Audit Required";
    ProfileArchetype["MR_ICA_FP_DADDY_MAIN_SCENARIO_4"] = "Mr FP Daddy Main Applicant Scenario 4 Late Birth Audit Required";
    ProfileArchetype["MRS_ICA_PR_MOMMY_SPOUSE_SCENARIO_4"] = "Mrs PR Mommy Spouse Applicant Scenario 4 Late Birth Audit Required";
    ProfileArchetype["MR_ICA_SC_DADDY_MAIN_SCENARIO_5"] = "Mr SG Daddy Main Applicant Scenario 5 Marriage Info Mismatch, Late Birth Audit Required";
    ProfileArchetype["MRS_ICA_SC_MOMMY_SPOUSE_SCENARIO_5"] = "Mrs SG Mommy Spouse Applicant Scenario 5 Marriage Info Mismatch, Late Birth Audit Required";
    ProfileArchetype["MRS_ICA_PR_MOMMY_MAIN_SCENARIO_6"] = "Mrs PR Mommy Main Applicant Scenario 6 Verify ID Required";
    ProfileArchetype["MR_ICA_SC_DADDY_MAIN_SCENARIO_7"] = "Mr SG Daddy Spouse Applicant Scenario 7 Verify ID,Marriage, Late Birth Audit Required";
    ProfileArchetype["MRS_ICA_SC_SINGLE_MOMMY_MAIN_SCENARIO_8"] = "Mrs SG Single Mommy Main Applicant Scenario 8 Audit Required";
})(ProfileArchetype = exports.ProfileArchetype || (exports.ProfileArchetype = {}));
