...
class OidcHelper {
    constructor(props) {
        ...
        this.constructAuthorizationUrl = (state, nonce) => {
            const queryParams = Object.assign(Object.assign(Object.assign({ state }, (nonce ? { nonce } : {})), (this.redirectUri ? { redirect_uri: this.redirectUri } : {})), { scope: "openid", client_id: this.clientID, response_type: "code" });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (result.request.res.responseUrl.includes("saml.singpass.gov.sg")) {
                    util_1.Logger.warn(`Attempted to refresh session with invalid session ID ${sessionId}`);
                    return SessionRefreshResult.INVALID_SESSION_ID;
                }
                return SessionRefreshResult.SUCCESS;
            }
            catch (e) {
                util_1.Logger.warn(`Singpass Error while attempting to refresh session for sessionId: ${sessionId}\nError:`, e);
